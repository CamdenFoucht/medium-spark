  ...
  return (
    <Layout hideBanner>
      ...
      <h1 className={styles.h1}>Get In Touch</h1>
        ...
        <Row>
        <Col xs={12} sm={7} className={styles.left}>
        ...
        <Col xs={12} sm={5} className={styles.right}>
        
        <h4 className={styles.contactInfo}>Contact Information</h4>
                <p>We're here for you, and we're wearing our thinking caps. Have a question about our services? Or just want to send us a message? Feel free to use the contact form, or email us at mail@mediumspark.com</p>
                <div className={styles.blurb}>
                  <p className={styles.address}>
                    <AiFillHome/>
                    <span>555 W 5th St, 35th Floor
                    <br /> Los Angeles, CA 90013, US</span>
                  </p>
                </div>
                <div className={styles.blurb}>
